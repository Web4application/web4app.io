...
prog.go:3:1: expected 'package', found '--' (and 1 more error
...
1. `go get gh.io/go.dev/prog.go`
2. `go run hello.go`

The godoc.org or https://go.dev has more information.
...
| ----------------------------------------------- | --------------------------------------- |
| `github.com/web4application/gh-io/prog.go`        | `github.com/chai2010/gettext-go`        |
...
func main() {
	...
	// v0.1.0 => gettext.PNGettext("prog.dev", "main.main", "hello", "hello2", n)
